    ...
    <div className="self-diagnosis-page">
      <div className="card">
        ...
        <div className="card-content">
          ...
          <p>
            Dyslexia affects 1 in 10 individuals, many of whom remain undiagnosed and receive little or no intervention
            services. For some individuals who have never been diagnosed, dyslexia is a hidden disability that may
            result in underemployment, academic challenges, and reduced self-confidence.
          </p>
          <p>
            Dyslexia is a specific reading disorder and does not reflect low intelligence. Do you think you may have
            dyslexia? Please complete the brief 10-question self-assessment tool below.
          </p>
        </div>
      </div>
      ...
      <div className="self-diagnosis-form">
        ...
        <form onSubmit={handleSubmit}>
              ...
              <div key={index} className="question">
                ...
                <div className="answer-options">
                  <label htmlFor={`question-${index}-yes`}>
                    <input
                      id={`question-${index}-yes`} // Unique id for the "Yes" option
                      type="radio"
                      name={`question-${index}`}
                      value="yes"
                  ...
                  <label htmlFor={`question-${index}-no`}>
                    <input
                      id={`question-${index}-no`} // Unique id for the "No" option
                      type="radio"
                      name={`question-${index}`}
                      value="no"
          ...
          <button type="submit" className="extension-info-button">
            Submit Responses
          </button>
        </form>
        <div className="result-note">
          <p>
            If you checked seven or more of these questions, this may indicate dyslexia. Consider seeking consultation
            from a specialist or a formal diagnostic assessment from a qualified examiner.
          </p>
        </div>
      </div>
    </div>
